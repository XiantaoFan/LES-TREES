...
R1 = 0.5_rprec / this%h_all * ( erf(this%sqrt6overdelta1*(xx + 0.5*this%h_all))    &
    - erf(this%sqrt6overdelta1*(xx - 0.5*this%h_all)) )
Rval = R1 * R2 / this%ell**3

end function val

!*******************************************************************************
subroutine init(this, delta1, delta2, h_all, Rt_all)
!*******************************************************************************
...
real(rprec), intent(in) :: delta1, delta2, h_all, Rt_all
