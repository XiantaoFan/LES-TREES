...
logical :: write_inflow_file = .false.  !add by mingwei for inflow write
logical :: read_inflow_file = .false.  !add by mingwei for inflow read
...
integer :: wbase = 100
!inflow write strat record
integer :: jt_start_write=1000   !add by hongliang for inflow write
